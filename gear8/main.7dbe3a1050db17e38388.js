...
jquery_default()(function () {
  // slider
  (function () {
    jquery_default()('.js-sliderFor').slick({
      fade: true,
      asNavFor: '.js-sliderNavTarget',
      nextArrow: '.js-next',
      prevArrow: '.js-previous'
    });
    jquery_default()('.js-sliderNav').slick({
      asNavFor: '.js-sliderForTarget',
      arrows: false
    });
    jquery_default()('.js-sliderNav2').slick({
      asNavFor: '.js-sliderForTarget',
      dots: true,
      arrows: false,
      fade: true
    });
    jquery_default()('.js-slider').slick({
      arrows: false,
      fade: true,
      autoplay: true,
      pauseOnFocus: false,
...

  {
    ...
    jquery_default()('.js-toggleNav').bind('click', function () {
...

  {
    ...
    jquery_default()('.js-sliderModal').slick({
      nextArrow: '.js-modalNext',
      prevArrow: '.js-modalPrevious',
      fade: true
    });
    jquery_default()('.js-toggleModal').bind('click', function (e) {
      e.preventDefault();
